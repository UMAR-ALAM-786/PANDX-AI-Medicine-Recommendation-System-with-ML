...
# Symptoms dictionary and diseases mapping
...
def home():
    if request.method == 'POST':
        ...
        if symptoms == "Symptoms" or not symptoms.strip():
            message = "Please enter symptoms, or you've entered misspelled symptoms."
        ...
        if predicted_disease is None:
            message = "One or more symptoms are not recognized. Please check your spelling and try again."
            return render_template('index.html', message=message)
